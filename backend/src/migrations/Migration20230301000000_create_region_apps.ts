...
export class Migration20230211100000_create_region_apps extends Migration {
  async up(): Promise<void> {
    await this.upMainRegion();
    await this.upIamSSO();
    await this.upIamMgt();
  }

  async upMainRegion(): Promise<void> {
    // Região Principal
    this.addSql(
  ...
  async upIamSSO(): Promise<void> {
    ...
    this.addSql(
      ...
      values (
        ...
        '11111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111',
        '${iamConfig.MAIN_APP_IAM}', '${iamConfig.MAIN_APP_IAM_NAME}', 'Sistema de visualização de acessos', false, false);`,
    );
